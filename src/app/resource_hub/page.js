  ...
  export default function ResourceHub() {
    return (
      <div className="container max-w-6xl py-12">
        <h1 className="text-4xl font-bold mb-8">Learning Resources Center</h1>
        
        <Tabs defaultValue="consultation" className="w-full">
          {/* Tab导航 */}
          <TabsList className="grid grid-cols-2 md:grid-cols-5 h-auto gap-2 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-muted rounded-lg p-6 flex items-center justify-center">
                  <div className="text-center">
                    <p className="text-sm text-muted-foreground">Predicted ATAR</p>
          ...
          <TabsContent value="blogs">
            <div className="grid gap-6">
              {[1, 2, 3].map((item) => (
                <article key={item} className="bg-card rounded-xl p-6 shadow-lg">
