...
export default function Achievements() {
  ...
  const sidebarContent = (
    <div className="space-y-2">
      ...
      {/* 高中部分 */}
      <Collapsible open={openSections.highSchool} onOpenChange={() => toggleSection('highSchool')}>
        <CollapsibleTrigger asChild>
          <Button variant="ghost" className="w-full justify-between">
            {lang === "en" ? "Senior High School" : "高中"}
            {openSections.highSchool ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
          </Button>
        </CollapsibleTrigger>
      ...
      {/* 初中部分 */}
      <Collapsible open={openSections.juniorHigh} onOpenChange={() => toggleSection('juniorHigh')}>
        <CollapsibleTrigger asChild>
          <Button variant="ghost" className="w-full justify-between">
            {lang === "en" ? "Junior High School" : "初中"}
            {openSections.juniorHigh ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
          </Button>
        </CollapsibleTrigger>
        <CollapsibleContent className="space-y-1 ml-4">
          <Button
      ...
      {/* 小学部分 */}
      <Collapsible open={openSections.primarySchool} onOpenChange={() => toggleSection('primarySchool')}>
        <CollapsibleTrigger asChild>
          <Button variant="ghost" className="w-full justify-between">
            {lang === "en" ? "Primary School" : "小学"}
            {openSections.primarySchool ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
          </Button>
        </CollapsibleTrigger>
        <CollapsibleContent className="space-y-1 ml-4">
          <Button
