const courseData = {
  en: {
    ...
    title: "Y10 Pre-VCE Maths Advanced",
    heroSection: {
      achievements: {
        title: "VCE Mathematics Track Record",
        historical: [
          {
            range: "From 2017 to 2024 VCE Maths Methods",
            items: [
              {
                number: 25,
          ...
          {
            range: "From 2017 to 2024 VCE Specialist Maths",
            items: [
              {
                number: 11,
    ...
    whyChooseUs: {
      partB: {
        title:
          "Building a Strong Foundation: Pre-VCE Maths Advance in Year 10？",
        contents: [
          {
            title:
    ...
    resources: {
      packages: [
        ...
        },
        {
          ...
          title: "4 unit/topic-based progress tests",
          desc: " ",
        },
        {
          icon: "calendar",
