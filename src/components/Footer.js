...
const content = {
  en: {
    ...
    campuses: {
      heading: "Campuses",
      items: ["Melbourne Box Hill", "Melbourne MW"],
    },
    quickLinks: {
      heading: "Quick Links",
      items: ["Courses", "Teachers", "FAQ"],
    },
    contact: {
      heading: "Contact Us",
      email: "info@austinedu.com",
        ...
        <div>
          ...
          <div className="space-y-2 text-sm">
            <p className="text-sm text-gray-100">
              <a href="mailto:info@austinedu.com" className="hover:underline">
                {locale.contact.email}
              </a>
            </p>
            <p className="text-sm text-gray-100">
              <a href="tel:+610123456789" className="hover:underline">
            ...
            <div className="mt-3 space-x-3">
              ...
              <a href="#" aria-label="Xiaohongshu" className="inline-block">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
